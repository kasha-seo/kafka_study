...
confluent.telemetry.labels.confluent.operator.version=v0.419.10
{{- if $telemetry.proxy }}
...
confluent.metadata.ssl.truststore.location=/tmp/truststore.jks
confluent.metadata.ssl.truststore.password=${file:/mnt/secrets/jksPassword.txt:jksPassword}
{{- end }}
{{- end }}
{{- end }}
